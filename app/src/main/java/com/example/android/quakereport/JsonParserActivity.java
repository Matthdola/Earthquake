...
public class JsonParserActivity extends AppCompatActivity {
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(JsonParserActivity.this, "Json Data is downloading", Toast.LENGTH_SHORT).show();
        }

        @Override
        protected void onPostExecute(Void aVoid) {
            super.onPostExecute(aVoid);
            ListAdapter adapter = new SimpleAdapter(JsonParserActivity.this,
                    contactList, R.layout.earthquake_activity, new String[]{"email", "mobile"},
